...
def run_descarga(delay=3):
    """Ejecuta la descarga de la lista por defecto de patentes. Llamado desde main.py."""
    patents_to_download = [
        "US8550777B2",
        "US8936435B2",
        "US8834130B2",
    ...
    print("=" * 60 + "\n")
    resultados = descargar_lista_patents(patents_to_download, delay=delay)
    print("\n Proceso completado!")
